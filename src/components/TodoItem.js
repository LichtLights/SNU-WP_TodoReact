...
const TodoItem = ({ todo, onToggle, onStar, onDelete }) => {
  // 각 할 일 항목을 렌더링합니다.
  return (
    <li className={styles.todoItem}>
      ...
      <span
        ...
        style={{ textDecoration: todo.completed ? "line-through" : "none", color: todo.star_ed ? "#cc0000" : "#000000" }}
      >
        {todo.text}
      </span>

      <button className={styles.star} onClick={onStar}>⭐</button>
